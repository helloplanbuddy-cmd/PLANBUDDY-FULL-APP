...
// ✅ IDEMPOTENCY ENFORCEMENT: Idempotency-Key header REQUIRED
router.post('/payment/verify', authenticate, verifyPaymentLimiter, validate(VerifyPaymentSchema), idempotency.strict, paymentController.verifyPayment);
...
// ✅ IDEMPOTENCY ENFORCEMENT: Idempotency-Key header REQUIRED
router.post('/admin/payments/:paymentId/reconcile', authenticate, adminLimiter, requireRole('admin'), validateAll({ params: RoutePaymentIdSchema }), idempotency.strict, paymentController.manualReconcile);
